...
print("aspect ratio screen: ", aspect_ratio_screen)
...
def detect_finger_down(hand_landmarks):
    ...
    cv2.line(output,(x_base1,y_base1),(x_index,y_index),color_base,3)
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                ym = np.interp(x,(X_Y_INI, X_Y_INI + area_height), (SCREEN_GAME_Y_INI,SCREEN_GAME_Y_FIN))
        ...
        # cv2.imshow("Live Hand Tracker, made by Angel Mtz",frame)
        cv2.imshow('By Angel Martinez', output)
